...
def upgrade() -> None:
    ...
    op.add_column(
        "userstats", sa.Column("matches_played_field", sa.Integer(), nullable=False)
    )
    op.add_column(
        "userstats", sa.Column("matches_played_command", sa.Integer(), nullable=False)
    )
    op.add_column(
        "userstats", sa.Column("matches_won_field", sa.Integer(), nullable=False)
    )
    op.add_column(
        "userstats", sa.Column("matches_won_command", sa.Integer(), nullable=False)
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column(
        "userstats", sa.Column("matches_played", sa.INTEGER(), nullable=False)
    )
